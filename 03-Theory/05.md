# Тема 5. Компютърни архитектури. Формати на данните. Вътрешна структура на централен процесор - блокове и конвейерна обработка, инструкции. 
...
- Централен процесор (ЦП, CPU)
    - изпълнява всички аритметични и логически операции, управлява изпълнението на инструкциите и контролира взаимодействието между останалите компоненти.
- Паметова система
    ...
    - Вътрешна памет
        ...
        - RAM (оперативна памет), кеш памет и регистри.
    - Външна памет
        - осигурява дългосрочно и устойчиво съхранение на информация.
        - твърди дискове, SSD, външни носители.
...
- Мрежов интерфейс (Network Interface Card, NIC)
    - хардуерен модул, който осигурява връзка между компютъра и локални или глобални мрежи (LAN, WAN, Интернет), поддържа стандарти като Ethernet, Wi-Fi и др.
...
- Остават 4 неизползвани комбинации.
...
- Сегментни регистри
    - 6 на брой, позволяват да се използва в сегментен модел на организация на паметта.
- Служебни регистри:
...
### Блок за работа с числа с плаваща запетая
...
- Низови инструкции
    - Инструкции за работа с последователности от байтове или символи (низове), например копиране, сравнение или търсене на символ
- безусловни и условни преходи
